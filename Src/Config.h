...
namespace ParagliderVR
{
    struct Settings
    {
        ...
        float gesturePositionTolerance = 20.0f;
        float gestureRotationToleranceDegrees = 40.0f;
        float gestureMinimumConfidence = 0.10f;
        float gestureTransitionSpeed = 5.0f;
        float exhaustedHorizontalSpeedScale = 0.50f;
        float exhaustedFallMultiplier = 0.65f;
        float staminaPerSecond = 8.0f;
        bool fireLiftEnabled = true;
        float fireLiftHorizontalRadius = 120.0f;
        float fireLiftMaximumHeight = 450.0f;
        float fireLiftVerticalImpulse = 2500.0f;
        float fireLiftImpulseDuration = 0.20f;
        float fireLiftScanInterval = 0.10f;
